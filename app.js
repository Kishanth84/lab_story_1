...
function moreAboutKaren(parents=String, noOfSiblings=Number, isNuclearFamily=Boolean) 
{
    return typeof(parents=String)+typeof(noOfSiblings)+typeof(isNuclearFamily)
}
